...
class VerificationController extends GetxController {
  ...
  void verificationFuncation() async {
  setLoading = true;
  ...
  try {
    var response = await http.get(
      ...
      if(response.statusCode == 200) {
        ...
        Get.snackbar("You are successfully verified", "Enjoy your awesom experience",
        ...
        Get.snackbar("Faild to verify account", error.message, 
        colorText: kLightWhite,
