...
String googleApiKey = 'AIzaSyAz3HFs3h9uQgPaPY1vALB1vX9inCqt7tE';
...
const kBlueDark =  Color.fromARGB(255, 14, 34, 65);
...
final List<String> verificationReasons = [
  'Real-time Updates: Get instant notifications aboud your order status.',
  ...
  'Exclusive Offers: Stay in the loop for spacial deals and promotions.',
];